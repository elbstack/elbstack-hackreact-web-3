...
export default class ChannelList extends Component {
  ...
  render() {
    ...
    const content = this.props.channels !== undefined && this.props.channels.list !== undefined ?
      <ul>
        { Object.keys(this.props.channels.list).map( (channelId) => <li key={channelId} onClick={this.onJoinChannel.bind(this, channelId)}>{this.props.channels.list[channelId].name}</li> )}
      </ul>
      : <p>Lade Channels</p>
